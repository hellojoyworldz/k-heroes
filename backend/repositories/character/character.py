...
from models.character.character import CharacterCreate, CharacterReorderRequest, CharacterUpdate, TurnStatWrite
from repositories.character import character_category
from repositories.character.character_search import apply_character_search_filters
from repositories.character.character_stats import stats_to_storage
from repositories.character.character_turn_stats import (
...
def _filtered_character_query(
    ...
    *,
    ...
    query = apply_character_search_filters(query, db=db, name=name, tag=tag)
    if category_id is not None:

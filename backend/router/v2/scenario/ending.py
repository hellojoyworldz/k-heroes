...
from models.scenario.ending import EndingAdminResponse, EndingCreate, EndingReorderRequest, EndingUpdate
from models.common.pagination import ALLOWED_PAGE_SIZES, PaginatedResponse
from repositories.scenario import ending as ending_repository
from repositories.character.character import CharacterNotFoundError
